...
from services.comparison.compare_builds_service import parse_component_ids, compare_builds
...
class CompareBuildsServiceTestCase(unittest.TestCase):
    ...
    def test_compare_builds_returns_expected_items(self):
        ...
        with patch('services.comparison.compare_builds_service.Build', new=fake_build), \
             patch('services.comparison.compare_builds_service.Component', new=fake_component), \
             patch('services.comparison.compare_builds_service.CompatibilityService.evaluate_build', return_value={'compatible': True}) as mocked_eval:
