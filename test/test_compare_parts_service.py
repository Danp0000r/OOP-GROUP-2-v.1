...
class ComparePartsServiceTestCase(unittest.TestCase):
    ...
    def test_compare_components_returns_empty_result_when_no_components(self):
        ...
        with patch('services.comparison.compare_parts_service.Component', new=fake_component):
    ...
    def test_compare_components_formats_output_and_same_type(self):
        ...
        part1.to_dict.return_value = {'category': 'RAM', 'name': 'RAM-A', 'brand': 'BrandA', 'price': 50, 'specs': {'speed': '3200MHz'}}

        part2 = MagicMock()
        part2.component_id = 2
        part2.to_dict.return_value = {'category': 'RAM', 'name': 'RAM-B', 'brand': 'BrandB', 'price': 60, 'specs': {'speed': '3600MHz'}}
