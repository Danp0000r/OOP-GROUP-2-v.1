"""
BASE COMPONENT MODEL - Abstract Base for All Hardware Components
Demonstrates: INHERITANCE, ABSTRACTION, ENCAPSULATION, POLYMORPHISM

All component types (CPU, GPU, RAM, etc.) now inherit from BaseComponent,
providing consistent interface while allowing specialized behavior.
"""
...
class BaseComponent:
    ...
    - ABSTRACTION: Defines component interface
    - INHERITANCE: All components inherit from this
    - ENCAPSULATION: Protected methods for filtering
    - POLYMORPHISM: Subclasses implement category-specific logic
    """
    ...
    def __init__(self, component_obj=None):
        """
        Initialize with SQLAlchemy Component object.
